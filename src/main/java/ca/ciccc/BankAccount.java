...
public class BankAccount {
    ...
    public String toString() {
        if (this.balance<0)
            return String.format("%s, -$%.2f",this.getName(),Math.abs(this.balance));
        return String.format("%s, $%.2f",this.getName(),this.balance);//this.getName()+", $"+this.balance;
    }
}
