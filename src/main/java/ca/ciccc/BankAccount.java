...
public class BankAccount {
     ...
     */
    public String transfer(double amount, BankAccount other) {
        double fee = 5.00;
        double total = 0;
        double BankAccount = this.getBalance();
        for (int i = 1; i < transactionCount; i++) {
            total = amount + (i * fee);
        ...
        public String toString(){
            ...
            if (getBalance() < 0) {
                return String.format(name + String.format("-%.2f", Math.abs(getBalance())));
